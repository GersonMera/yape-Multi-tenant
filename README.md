...
### 🎨 4. Diseño Corporativo Full-Screen con SIDEBAR (Estilo Linear / Bloomberg / Vercel)
...
- **Paleta Dark Obsidian Monocromática:** Fondo oscuro sobrio (`#08090E`), superficies pizarra oscura mate (`#0D0E16`) y un único acento morado oficial de marca (`#8B5CF6`).
- **Tipografía Oficial Google Fonts:** Incorpora **Plus Jakarta Sans** para jerarquía visual y **JetBrains Mono** para alineación contable y lectura numérica.
